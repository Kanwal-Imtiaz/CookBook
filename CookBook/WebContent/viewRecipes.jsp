...
<%@ page import="com.cookbook.RecipeBook"%>
	...
	<div class="row-top">
		<div class="main">
			<div class="wrapper">
				...
				<nav>
				<ul class="menu">
					<li><a href="MyBook.jsp">MyBook</a></li>
		...
		<div class="wrapper">
			...
			<ul class="price-list p2">
				...
				<%
			        ...
			        ArrayList<RecipeBook> recipeList = r.getRecipesFromDB();
				%>
				...
				<li><span> <a style="color: #b3e67f"
						...
						onmouseout="this.style.color='#b3e67f'" href="#">Add to MyBook</a>
				</span><a href="ShowRecipe.jsp"><%= recipeList.get(i).getR_name() %></a></li>
				<% } %>
